...
titanic_train2 <- select(titanic_train2, PassengerId,Survived, Pclass, Age, Sex, SibSp,
                         Parch, Embarked)
summary(titanic_test)
test <- select(titanic_test, PassengerId, Pclass, Age, Sex, SibSp,
               Parch, Embarked)
...
summary(output.df)
write.csv(output.df,"untitle9_baselinecode.csv",row.names = FALSE)
